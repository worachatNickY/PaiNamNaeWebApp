    ...
    <aside id="sidebar" class="fixed bottom-0 left-0 bg-white shadow-lg sidebar top-16">
        <div class="py-4">
            ...
            <nav class="px-3 space-y-1">
                ...
                <NuxtLink to="/admin/activity-logs"
                    class="sidebar-item flex items-center gap-3 px-3 py-2.5 text-gray-700 rounded-lg hover:bg-blue-50"
                    active-class="font-semibold text-blue-600 bg-blue-50">
                    <i class="w-6 text-lg text-center text-gray-500 fas fa-history"></i>
                    <span class="sidebar-text">Activity Logs</span>
                </NuxtLink>

                <NuxtLink to="/admin/emergencies"
                    class="sidebar-item flex items-center gap-3 px-3 py-2.5 text-gray-700 rounded-lg hover:bg-blue-50"
                    active-class="font-semibold text-blue-600 bg-blue-50">
                    <i class="w-6 text-lg text-center text-gray-500 fas fa-clipboard-list"></i>
                    <span class="sidebar-text">Incident Reports</span>
                </NuxtLink>
                ...
                <NuxtLink to="/admin/reports"
                    ...
                    <span class="sidebar-text">Driver Reports</span>
                </NuxtLink>

                <NuxtLink to="/admin/reviews"
                    class="sidebar-item flex items-center gap-3 px-3 py-2.5 text-gray-700 rounded-lg hover:bg-blue-50"
                    active-class="font-semibold text-blue-600 bg-blue-50">
                    <i class="w-6 text-lg text-center text-gray-500 fas fa-star"></i>
                    <span class="sidebar-text">Review Management</span>
                </NuxtLink>

                <NuxtLink to="/admin/messages"
                    class="sidebar-item flex items-center gap-3 px-3 py-2.5 text-gray-700 rounded-lg hover:bg-blue-50"
                    active-class="font-semibold text-blue-600 bg-blue-50">
                    <i class="w-6 text-lg text-center text-gray-500 fas fa-comments"></i>
                    <span class="sidebar-text">Chat Logs</span>
                </NuxtLink>
