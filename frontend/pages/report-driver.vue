    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white border-b border-gray-200 shadow-sm">
            <div class="px-4 py-6 mx-auto max-w-2xl">
                <NuxtLink to="/" class="flex items-center gap-2 mb-4 text-gray-600 hover:text-gray-900">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button v-for="typeKey in typesByCategory[form.category]" :key="typeKey"
                            ...
                            <div class="flex justify-center mb-2">
                                ...
                                <!-- DIRTY_VEHICLE -->
                                <svg v-else-if="typeKey === 'DIRTY_VEHICLE'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                                </svg>
                                <!-- VEHICLE_MALFUNCTION -->
                                <svg v-else-if="typeKey === 'VEHICLE_MALFUNCTION'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z" />
                                </svg>
                                <!-- BAD_SMELL -->
                                <svg v-else-if="typeKey === 'BAD_SMELL'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                                </svg>
                                <!-- RUDE_BEHAVIOR -->
                                <svg v-else-if="typeKey === 'RUDE_BEHAVIOR'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.182 16.318A4.486 4.486 0 0012.016 15a4.486 4.486 0 00-3.198 1.318M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" />
                                </svg>
                                <!-- UNPROFESSIONAL -->
                                <svg v-else-if="typeKey === 'UNPROFESSIONAL'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                <!-- WRONG_ROUTE -->
                                <svg v-else-if="typeKey === 'WRONG_ROUTE'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 00-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0z" />
                                </svg>
                                <!-- UNSAFE_FEELING / HARASSMENT -->
                                <svg v-else-if="['UNSAFE_FEELING', 'HARASSMENT'].includes(typeKey)" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.249-8.25-3.286zm0 13.036h.008v.008H12v-.008z" />
                                </svg>
                                <!-- INTOXICATED -->
                                <svg v-else-if="typeKey === 'INTOXICATED'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                <svg v-else-if="typeKey === 'REFUSED_PAYMENT_METHOD'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
                                </svg>
                                <!-- NO_SHOW -->
                                <svg v-else-if="typeKey === 'NO_SHOW'" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" :class="form.type === typeKey ? 'text-blue-600' : 'text-gray-400'" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
